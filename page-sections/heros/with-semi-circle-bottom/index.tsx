  ...
  return (
    <div className="relative z-10 pt-12 overflow-hidden to bg-primary-500 bg-gradient-to-b from-primary-600 lg:pt-0">
      <div className="max-w-full px-4 m-auto mt-28 sm:px-8 lg:max-w-5xl">
        <Banner />
        <div className="relative z-30 w-full mt-12 ">
          <div className="relative max-w-lg m-auto text-center md:m-4 md:text-left">
            <h1 className="relative z-30 text-4xl font-extrabold text-white drop-shadow-md sm:text-5xl md:text-6xl ">
              {heading1}
            </h1>
            <h2 className="relative z-30 my-4 text-xl font-bold text-primary-200 drop-shadow-md sm:text-2xl md:text-3xl ">
              {heading2}
            </h2>
            <p className="relative z-30 my-12 text-md text-primary-50 drop-shadow-md sm:text-lg ">
              {intro}
            </p>
      ...
      <div className="relative hidden m-auto max-w-7xl md:block">
        <div className="absolute z-20 -bottom-28 right-16 lg:right-48 ">
          <Image src={image} alt={alt} width={250} height={500} />
        </div>
      </div>
